...
class Page2:
    """Gérez facilement les informations des élèves"""
                    ...
                    Container(
                        ...
                        foreground_decoration=BoxDecoration(
                            image=DecorationImage(
                                src="assets/images/page2.png", fit=BoxFit.COVER
                            )
                        ),
                    ),
                    Container(
                        ...
                        content=Column(
                            controls=[
                                ...
                                Text(self.get_text("page2content")),
                                Row(
                                    controls=[
                                        OutlinedButton(
                                            content=self.get_text("previous"),
                                            on_click=lambda e: self.to_next_page(1),
                                        ),
                                        Button(
                                            content=self.get_text("next"),
                                            on_click=lambda e: self.to_next_page(3),
