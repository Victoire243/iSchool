...
class Page4:
    """Page 4 — Sécurité et accessibilité"""
                    ...
                    Container(
                        ...
                        foreground_decoration=BoxDecoration(
                            image=DecorationImage(
                                src="assets/images/page4.png", fit=BoxFit.COVER
                            )
                        ),
                    ),
                    Container(
                        ...
                        content=Column(
                            controls=[
                                ...
                                Text(self.get_text("page4content")),
                                Row(
                                    controls=[
                                        OutlinedButton(
                                        ...
                                        Button(
                                            ...
                                            on_click=lambda e: self.to_next_page(5),
