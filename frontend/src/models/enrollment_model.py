class EnrollmentModel:
    ...
    def __repr__(self) -> str:
        return f"EnrollmentModel(id_enrollment={self.id_enrollment}, student_id={self.student_id}, classroom_id={self.classroom_id}, school_year_id={self.school_year_id}, status='{self.status}')"
